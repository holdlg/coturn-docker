...
* `EXTERNALIP`: External IP needed for turn. Defaults to `11.11.11.11`
...
```bash
# Clone
git clone https://github.com/holdlg/coturn.git

# Build
docker build -t holdlg/coturn .

# Tag
VERSION=0.0.1
docker tag holdlg/coturn holdlg/coturn:$VERSION

# Push
docker push holdlg/coturn:latest
docker push holdlg/coturn:$VERSION
```

# Thanks

The initial image of this image was created by [anastasiia-zolochevska/turn-server-docker-image](https://github.com/anastasiia-zolochevska/turn-server-docker-image) and [boldt/turn-server-docker-image](https://github.com/boldt/turn-server-docker-image)